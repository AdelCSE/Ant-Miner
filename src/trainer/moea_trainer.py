...
if __name__ == "__main__":
    ...
    parser.add_argument("--min-examples", type=int, default=10, help="Minimum number of examples per class")
    parser.add_argument("--max-uncovered", type=int, default=10, help="Maximum number of uncovered examples")
    parser.add_argument("--max-iter", type=int, default=100, help="Maximum number of iterations")
    parser.add_argument("--gamma", type=float, default=0.9, help="Gamma parameter")
    parser.add_argument("--delta", type=float, default=0.5, help="Delta parameter")
    parser.add_argument("--alpha", type=int, default=1, help="Alpha parameter")
    parser.add_argument("--beta", type=int, default=1, help="Beta parameter")
