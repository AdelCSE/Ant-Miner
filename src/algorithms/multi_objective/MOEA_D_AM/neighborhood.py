...
def find_best_neighborhood_rule(colony, data, ant_index, neighborhood, rep_list, neighbors, weights, decomposition, reference, labels, task):
    ...
    for i in neighborhood[ant_index][:neighbors]:
        ...
        if task == 'single':
            ...
            if new_g > ant_g and colony['ants'][i]['rule'][-1][1] == 'pos':
                ...
                colony['ants'][ant_index]['fitness'], colony['ants'][ant_index]['f1_score'] = fitness_function(data=data, ant=colony['ants'][ant_index], labels=['class'], task=task)
                ant_g = new_g
            ...
            if new_g > ant_g:
                ...
                colony['ants'][ant_index]['ruleset']['fitness'], colony['ants'][ant_index]['ruleset']['f1_score'] = fitness_function(data=data, ant=colony['ants'][ant_index], labels=labels, task=task)
                ant_g = new_g
                best_ruleset = new_ruleset
                changed_rule = True
